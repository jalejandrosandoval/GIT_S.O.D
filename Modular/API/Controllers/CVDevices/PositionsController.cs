...
namespace API.Controllers.CVDevices
{
    ...
    public class PositionsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Positions>> PostPositions(Positions positions)
        {
            ...
            return CreatedAtAction("GetPositions", new { id = positions.Id_Positions }, positions);
        }
        ...
        {
            return _context.Positions.Any(e => e.Id_Positions == id);
        }
    }
}
